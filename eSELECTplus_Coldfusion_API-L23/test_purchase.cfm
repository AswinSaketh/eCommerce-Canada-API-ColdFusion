<cftry>
	...
	myTxn = formPurchaseArray( order_id, "15.02", "5454545454545454", "0509", "7" );
	</cfscript>


	<CF_mpgAPI_CF5 host="https://esqa.moneris.com:43924/gateway2/servlet/MpgRequest" store_id="store1" api_token="yesguy" txn_array="#myTxn#" cust_id="custiddata">
