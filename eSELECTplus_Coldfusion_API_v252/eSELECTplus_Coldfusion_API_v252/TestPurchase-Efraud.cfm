<cftry>
	...
	order_id = "MARTINEZeSelect" & OrderID;
...
// Declaring AVS values
	...
	myTxn = formPurchaseArray( order_id, "1.00", "4242424242424242", "0909", "7" );
	</cfscript>


<CF_mpgAPI_CF5 host="https://esqa.moneris.com:43924/gateway2/servlet/MpgRequest" store_id="store5" api_token="yesguy" txn_array="#myTxn#" avs_info_array="#avsInfo#" cvd_info_array="#cvdInfo#">
