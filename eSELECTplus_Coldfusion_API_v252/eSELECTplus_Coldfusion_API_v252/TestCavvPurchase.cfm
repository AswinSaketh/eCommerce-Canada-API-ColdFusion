<cftry>
	...
	myTxn = formCavvPurchaseArray( order_id, "1.00", "5454545454545454", "1212", "AAABBJg0VhI0VniQEjRWAAAAAAA" );
	</cfscript>


	<CF_mpgAPI_CF5 host="https://esqa.moneris.com:43924/gateway2/servlet/MpgRequest" store_id="store5" api_token="yesguy" txn_array="#myTxn#" avs_info_array="#avsInfo#" cvd_info_array="#cvdInfo#" dynamic_descriptor = "descriptor1">
