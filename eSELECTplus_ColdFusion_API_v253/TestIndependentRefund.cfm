<cftry>
	...
	myTxn = formIndRefundArray( order_id, "43.02", "5454545454545454", "1511", "7" );
	</cfscript>


	<CF_mpgAPI_CF5 host="https://esqa.moneris.com/gateway2/servlet/MpgRequest" store_id="store5" api_token="yesguy" txn_array="#myTxn#" dynamic_descriptor = "descriptor1">
