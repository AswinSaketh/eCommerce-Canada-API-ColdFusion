<cftry>
	...
	myTxn = formPurchaseArray( order_id, "43.02", "5454545454545454", "1511", "7" );
	myRecur = formRecurArray( "month", "true", "2020/11/30", "4", "1", "14.50" );
	</cfscript>


	<CF_mpgAPI_CF5 host="https://esqa.moneris.com/gateway2/servlet/MpgRequest" store_id="store5" api_token="yesguy" txn_array="#myTxn#" cust_info_array="#custInfo#" recur="#myRecur#">
