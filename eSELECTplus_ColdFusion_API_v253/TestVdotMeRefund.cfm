<cftry>
	...
	<cfscript>
		order_id = "RES_PURCH_0226201504:51:04";
		txn_number = "701171-1_10";
		amount = "0.50";
		crypt_type = "7";
		myTxn = formVdotMeRefundArray( order_id, txn_number, amount, crypt_type );

		//Optional
		cust_id = "customer 2";
		dynamic_descriptor = "descriptor 2";
