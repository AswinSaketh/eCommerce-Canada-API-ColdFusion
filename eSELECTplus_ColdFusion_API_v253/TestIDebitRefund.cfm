<cftry>
	...
	<cfscript>
	myTxn = formIDebitRefundArray( "cfm5-00102272015011305", "1.00", "415758-0_10" );
	</cfscript>


	<CF_mpgAPI_CF5 host="https://esqa.moneris.com/gateway2/servlet/MpgRequest" store_id="store3" api_token="yesguy" txn_array="#myTxn#">
