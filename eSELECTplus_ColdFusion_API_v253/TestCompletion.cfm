<cftry>
	...
	<cfscript>
	myTxn = formCompletionArray( "cfm5-40102272015125206", "1.00", "760065-0_10", "7");

	//optional - P = Partial and F = Final
	ship_indicator = "P";

	</cfscript>


	<CF_mpgAPI_CF5 host="https://esqa.moneris.com/gateway2/servlet/MpgRequest" store_id="store5" api_token="yesguy" txn_array="#myTxn#" ship_indicator="#ship_indicator#">
